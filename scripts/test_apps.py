...
sys.path.append(os.path.join(os.path.dirname(__file__), "..", "applications", "wallpapermanager"))
sys.path.append(os.path.join(os.path.dirname(__file__), "..", "installer"))
...
def main():
    ...
    try:
        ...
        from wallpapermanager import WallpaperManagerApp
        from gui_installer import JkerInstallerApp
    ...
    tests = [
        ...
        (WallpaperManagerApp, "Wallpaper Manager"),
        (JkerInstallerApp, "JKER Graphical Installer")
    ]
