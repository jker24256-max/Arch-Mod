...
class SentryOpsApp(QMainWindow):
    ...
    def subnet_scan_complete(self, hosts):
        ...
        if score > 75:
            self.rating_label.setStyleSheet("color: #D90429;") # Critical red
        elif score > 45:
            self.rating_label.setStyleSheet("color: #FF8C00;") # Orange
        else:
            self.rating_label.setStyleSheet("color: #00FF00;") # Green
