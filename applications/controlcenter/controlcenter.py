...
class ControlCenterApp(QMainWindow):
    ...
    def run_sys_cmd(self, cmd):
        """Helper to run system shell commands."""
        try:
    ...
    def apply_theme_settings(self):
        ...
        # In a real environment, this updates Hyprland/Waybar styling variables and triggers swww
        ...
        if ok:
            ...
            # Fallback success indication on live bootloader setup
    ...
    def apply_power_profile(self):
        ...
        # Interfacing with power-profiles-daemon
        p_mode = "balanced"
    ...
    def refresh_users_list(self):
        ...
        try:
            ...
            for line in lines:
                parts = line.split(":")
                uid = int(parts[2])
                # Show standard human users (UID >= 1000)
                if uid >= 1000 and uid < 65000:
                    self.user_list.addItem(parts[0])
        except Exception:
            # Fallback list for live/testing setups
